  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div
          className="absolute top-1/2 left-1/2 w-[80vw] md:w-[60vw] h-[80vw] md:h-[60vw] bg-gradient-to-br from-acid/10 to-transparent rounded-full blur-[80px] md:blur-[120px] mix-blend-screen transition-transform duration-100 ease-out"
          style={{ transform: 'translate(calc(-50% + var(--mouse-x, 0px) * -2), calc(-50% + var(--mouse-y, 0px) * -2))' }}
        ></div>
        <div
          className="absolute top-1/4 right-1/4 w-[40vw] md:w-[30vw] h-[40vw] md:h-[30vw] bg-purple-900/20 rounded-full blur-[60px] md:blur-[100px] mix-blend-screen transition-transform duration-300 ease-out"
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8 relative z-10">
        <div className="flex flex-col md:grid md:grid-cols-12 gap-8 md:gap-0">
          ...
          <div className="col-span-12 lg:col-span-8 flex flex-col justify-center items-center md:items-start relative pt-16 md:pt-0">
             ...
             <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full text-center pointer-events-none mix-blend-overlay opacity-20 md:opacity-30">
          ...
          {/* Bottom Right: CTA */}
          <div className="col-span-12 lg:col-span-2 flex items-center lg:items-end justify-center lg:justify-end mt-8 lg:mt-0 pb-8 lg:pb-16">
             <a
               href="#services"
