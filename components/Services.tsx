...
const Services: React.FC = () => {
  ...
  const service1Anim = useElementAnimation();
  const service2Anim = useElementAnimation();
  const service3Anim = useElementAnimation();

  const serviceAnims = [service1Anim, service2Anim, service3Anim];
  ...
  return (
    <section id="services" className="py-16 sm:py-24 md:py-32 bg-bg relative z-20">
      <div className="container mx-auto px-4 sm:px-6 md:px-12">
        ...
        <div
          ref={titleAnim.ref}
          className={`mb-12 sm:mb-16 md:mb-24 flex flex-col sm:flex-row sm:items-end justify-between border-b border-white/10 pb-4 gap-4 transition-all duration-1000 ${
        ...
        >
          ...
          <span className={`font-mono text-acid text-xs sm:text-sm transition-all duration-700 delay-300 ${
          ...
          {SERVICES.map((service, index) => {
            ...
            return (
              <a
                ...
                className="group relative border-b border-white/10 last:border-b-0 block cursor-pointer"
